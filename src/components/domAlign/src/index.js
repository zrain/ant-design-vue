...
function domAlign(el, refNode, align) {
  ...
  // window.console.info(`[${new Date().getTime()}]`,'visibleRect',visibleRect)
  // 当前节点所占的区域, left/top/width/height
  const elRegion = getRegion(source);
  // window.console.info(`[${new Date().getTime()}]`,'elRegion',elRegion)
  // 参照节点所占的区域, left/top/width/height
  const refNodeRegion = getRegion(target);
  // window.console.info(`[${new Date().getTime()}]`,'refNodeRegion',refNodeRegion)
